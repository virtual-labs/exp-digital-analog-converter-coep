var binaryweighted = function() {
	...
	this.switch_status = function(id) {
		 $("#run_button_binw").css('background-color','#E6E6FA');		
...
var r2rLadder = function() {
	...
	this.switch_status = function(id) {
		$("#run_button_r2r").css('background-color','#E6E6FA');
		var index = id.split("_",3)[1];
	...
	if($.browser.msie) {
		...
		//analog to digital
		{
			...
			$(function() {
				...
				$("#amp_a2d").change(function() {
					$("#run_button_a2d").css('background-color','#E6E6FA');
		...
		//resolution
		{
			...
			$("#run_button_binw").click(function() {
				 $("#run_button_binw").css('background-color','#32CD32');
				obj.r = $("#r").val();
				obj.setresistors();
				obj.setbinaryweighted();
			})
			...
			$("#run_button_r2r").click(function() {
				$("#run_button_r2r").css('background-color','#32CD32');
				obj_r2r.r = $("#r_r2r").val();
				obj_r2r.setresistors();
				obj_r2r.setr2rLadder();
			})
			...
			$("#run_button_a2d").click(function() {
				$("#run_button_a2d").css('background-color','#32CD32');
				obj_a2d.plotanalog();
			...
			$("#run_button_res").click(function() {
				...
				if(obj_res.bit != "--select--") {
					$("#run_button_res").css('background-color','#32CD32');
					...
					$("#run_button_res").css('background-color','#E6E6FA');
